...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // --- HARDCODE FIX: If no map, force Villa-370.svg ---
        if (savedUri == null) {
            try {
                java.io.File file = new java.io.File(getFilesDir(), "Villa-370.svg");
                if (!file.exists()) {
                    java.io.InputStream is = getAssets().open("Villa-370.svg");
                ...
                Log.e("HomeActivity", "Error copying Villa-370.svg", e);
            }
        }
        // ------------------------------------------------
