...
public class AutoPublicationHelper {
    ...
    public static void setupBidirectionalPublication(
        ...
        Log.d(TAG, "🔥 ==================================================");
        Log.d(TAG, "🔥 [TEMP_LOG] BIDIRECTIONAL PUBLICATION SETUP:");
        Log.d(TAG, String.format("🔥   Client Node: 0x%04X -> Client Element Index [%d] (Address: 0x%04X)",
                clientNode.getUnicastAddress(), clientElementIndex, clientElementAddr));
        Log.d(TAG, String.format("🔥   Newly Added Server Node: 0x%04X -> Server Element Index [%d] (Address: 0x%04X)",
                serverNode.getUnicastAddress(), serverElementIndex, serverElementAddr));
        Log.d(TAG, "🔥 ==================================================");
